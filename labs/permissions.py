...
STAFF = {
    UserRole.SUPER_ADMIN, UserRole.ADMIN, UserRole.DOCTOR, UserRole.NURSE, UserRole.LAB, UserRole.PHARMACY, UserRole.FRONTDESK
}
...
class CanViewLabOrder(BasePermission):
    ...
    Staff: can view orders in their facility.
    """
